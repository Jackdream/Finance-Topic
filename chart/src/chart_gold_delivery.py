...
plt.plot(hjjys_price['日期'], hjjys_price['交割量(kg)'], label='交割量(kg)', linewidth=0.5)

plt.title('交割量', fontsize=16, fontweight='bold', y=1.02)
...
plt.tight_layout()
# plt.show()
plt.savefig('./output/上海黄金交易所交割量20260227.png', dpi=300, bbox_inches='tight', facecolor='white')
